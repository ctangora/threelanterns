...
def get_queue(
    ...
    min_untranslated_ratio: float | None = Query(default=None, ge=0.0, le=1.0),
    max_untranslated_ratio: float | None = Query(default=None, ge=0.0, le=1.0),
    detected_language: str | None = Query(default=None),
    min_usability: float | None = Query(default=None, ge=0.0, le=1.0),
    max_usability: float | None = Query(default=None, ge=0.0, le=1.0),
    min_relevance: float | None = Query(default=None, ge=0.0, le=1.0),
    max_relevance: float | None = Query(default=None, ge=0.0, le=1.0),
    relevance_state: str | None = Query(default=None, pattern="^(accepted|borderline|filtered)$"),
